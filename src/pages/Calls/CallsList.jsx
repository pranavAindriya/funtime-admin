...
const CallsList = () => {
  ...
  const formattedRecentCalls = () => {
    return (
      callData?.data?.data?.map((call, ind) => ({
        ...
        endCallTime: formatDate(call?.endCallTime),
        startCallTime: formatDate(call?.startCallTime),
  ...
  const columns = [
    ...
    { field: "startCallTime", headerName: "Start Time", flex: 1 },
    { field: "endCallTime", headerName: "End Time", flex: 1 },
